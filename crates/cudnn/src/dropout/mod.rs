...
impl CudnnContext {
    ...
    ///
    /// * `reserved_space` - user-allocated GPU memory used by this function. It is expected that
    ...
    /// `reserved_space` is less than the value returned by `get_dropout_reserve_space_size`.
    ///
    /// # Examples
    ///
    /// ```
